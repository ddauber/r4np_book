...
When comparing multiple paired groups, matters become slightly more complicated. On the one hand, our groups are not really groups anymore, because it refers to the same group of people person who provide multiple measures, usually over an extended period of time. In experimental studies, this can also refer to different 'treatments' or 'conditions' participants are exposed to. On the other hand, we also have to deal with yet another assumption: Sphericity.

Sphericity assumes that the variance between all groups is roughly the same. Thus,
