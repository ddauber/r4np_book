...
Lastly, if you would like to install all necessary packages to follow the examples in this book, the `r4np` package comes with a handy function to install them all at once. Of course, you need to have `r4np` installed first, as shown [above](#install-r4np).
