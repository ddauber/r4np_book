...
```{r Arthimetic examples, echo=TRUE}
# Addition
10+5
...
```{r Concatenate function error, echo=TRUE, error=TRUE}
friends <- c("Fiona" "Ida")
```
...
```{r Mean of an object with characters, echo=TRUE, error=TRUE}
mean(friends)
```
...
```{r NaN example: Division by zero, echo=TRUE, error=TRUE}
# Example 1
0/0
