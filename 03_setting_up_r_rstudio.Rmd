...
Before you start programming away, you might want to make some tweaks to your settings right away to have a better experience (in my humble opinion). I recommend at least the following changes by clicking on `RStudio > Preferences` or press `Ctrl + ,` on a Windows computer or `⌘ + ,` if your are on a Mac:
