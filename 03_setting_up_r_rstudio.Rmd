...
3.  On the next page, make sure you have the free plan select and click on `Sign up`.
...
6.  To start a new R project, you can click on `New Project > New RStudio Project`. This will open R Studio in the Cloud, which looks identical to the desktop version. You can start writing your code. The example below aims to compute a plot.[^setting_up_r_rstudio-1]

    ![](images/chapter_03_img/rstudio_cloud/06_rstudio_cloud.png)

7.  Now we can execute the code as we would on the desktop version.
