...
1.  Go to [http://posit.co](http://posit.co "http://posit.co"){target="_blank"} and click on `DOWNLOAD RSTUDIO`.
    ...
    ![](images/chapter_03_img/rstudio/01_posit_main_page.png)

2.  Click on `DOWNLOAD RSTUDIO` on this page.

    ![](images/chapter_03_img/rstudio/02_posit_rstudio_desktop.png)
...
3.  This leads you to the page where you can install *R* as a first step and RStudio as a second step. Since we installed *R* already, we can click on `DOWNLOAD RSTUDIO DESKTOP FOR WINDOWS` (or for Mac if you are not using a PC).
    ...
    ![](images/chapter_03_img/rstudio/03_posit_installer.png)
...
4.  If for some reason the version for your operating system is not showing up correctly, you can scroll down and find other version ready to be installed.
    ...
    ![](images/chapter_03_img/rstudio/04_other_installers.png)
